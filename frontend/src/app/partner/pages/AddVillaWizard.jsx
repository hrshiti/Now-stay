                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      onBlur={(e) => { if (!e.target.value) e.target.type = 'text'; }}
                    />
                    <div className="absolute left-[16px] top-1/2 -translate-y-1/2 text-gray-400 pointer-events-none"><Clock size={18} /></div>
                  </div>
                </div>
              </div>
          ...
          {step === 9 && (
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="space-y-4">
                ...
                {/* 3. Villa Details & Pricing */}
                <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Villa Inventory ({roomTypes.length})</h3>
