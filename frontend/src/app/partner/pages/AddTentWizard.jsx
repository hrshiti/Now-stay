                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <span className="absolute left-[14px] top-1/2 -translate-y-1/2 text-gray-400 font-bold">₹</span>
                          <input className="input !pl-10 w-full" type="number" value={editingRoomType.extraAdultPrice} onChange={e => setEditingRoomType({ ...editingRoomType, extraAdultPrice: e.target.value.replace(/^0+(?!$)/, '') })} />
                        </div>
                      </div>
                      <div className="space-y-1">
                        ...
                        <div className="relative">
                          <span className="absolute left-[14px] top-1/2 -translate-y-1/2 text-gray-400 font-bold">₹</span>
                          <input className="input !pl-10 w-full" type="number" value={editingRoomType.extraChildPrice} onChange={e => setEditingRoomType({ ...editingRoomType, extraChildPrice: e.target.value.replace(/^0+(?!$)/, '') })} />
                        </div>
                      </div>
                    </div>
