          ...
          {step === 9 && (
            <div className="space-y-6">
              <div className="bg-emerald-50 rounded-2xl p-4 border border-emerald-100 flex gap-3">
                ...
                <div>
                  <h3 className="font-bold text-gray-900">Review tent Details</h3>
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-2xl p-5 bg-white shadow-sm">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap gap-2 py-1">
                      <span className="px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded uppercase">{propertyForm.tentType} Tent</span>
                      <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded uppercase">{propertyForm.washroomType} Washroom</span>
                      <span className="px-2 py-0.5 bg-emerald-50 text-emerald-600 text-[10px] font-bold rounded uppercase">{propertyForm.viewType} View</span>
                    </div>
                ...
                <div className="border border-gray-200 rounded-2xl p-5 bg-white shadow-sm">
                  <h3 className="text-sm font-bold text-gray-900 border-b border-gray-100 pb-2 mb-3">Tents & Rooms ({roomTypes.length})</h3>
                  {roomTypes.length > 0 ? (
                    <div className="space-y-2">
                      {roomTypes.map((rt, i) => (
                  ...
                  ) : <div className="text-xs text-red-500 font-medium bg-red-50 p-2 rounded-lg">No tent types added!</div>}
                </div>
                  ...
                  <div className="space-y-2">
                    {propertyForm.documents.map((doc, i) => (
                      <div key={i} className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-xs text-gray-400">{doc.fileUrl ? 'Attached' : 'Required'}</span>
                      </div>
                    ))}
                  </div>
                </div>
