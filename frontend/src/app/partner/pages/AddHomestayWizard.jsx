...
import {
  ...
  BedDouble, Wifi, Coffee, Car, Users, CheckSquare, Snowflake, Tv, ShowerHead, ArrowLeft, ArrowRight, Clock, Loader2, Camera, X, Eye, Upload
} from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <input className="input" placeholder="Pincode / Zip" maxLength={6} value={propertyForm.address.pincode} onChange={e => updatePropertyForm(['address', 'pincode'], e.target.value.replace(/\D/g, ''))} />
                </div>
                  ...
                  <div className="p-4 space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input className="input" type="number" placeholder="2" value={editingRoomType.maxAdults} onChange={e => setEditingRoomType({ ...editingRoomType, maxAdults: e.target.value.replace(/^0+(?!$)/, '') })} />
                      </div>
                      <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-500">Max Children</label>
                        <input className="input" type="number" placeholder="1" value={editingRoomType.maxChildren} onChange={e => setEditingRoomType({ ...editingRoomType, maxChildren: e.target.value.replace(/^0+(?!$)/, '') })} />
                      </div>
                    </div>
