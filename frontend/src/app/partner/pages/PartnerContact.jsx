          ...
          >
            ...
            <div className="p-6 space-y-5">
              ...
              <button
                ...
                className={`w-full py-3.5 text-white rounded-2xl font-black text-sm flex items-center justify-center gap-2 transition active:scale-95 disabled:cursor-not-allowed ${
