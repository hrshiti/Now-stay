...
const AddHotelWizard = () => {
  ...
  useEffect(() => {
    ...
    const handleUnload = (e) => {
      localStorage.setItem(STORAGE_KEY, JSON.stringify({ step, propertyForm, roomTypes, createdProperty }));
      // Trigger browser confirmation dialog to prevent accidental refresh
      if (step > 1 && !isEditMode) {
        e.preventDefault();
        e.returnValue = 'Are you sure you want to leave? Your progress is saved as a draft, but you will need to resume from this step.';
