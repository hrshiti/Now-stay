...
const AddHotelWizard = () => {
    ...
    const loadForEdit = async () => {
      ...
      try {
        ...
        setPropertyForm({
          ...
          documents: docs.length ? docs.map((d) => ({ type: d.type || d.name, name: d.name, fileUrl: d.fileUrl || "", required: REQUIRED_DOCS_HOTEL.find((rd) => rd.type === (d.type || d.name))?.required || false })) : REQUIRED_DOCS_HOTEL.map((d) => ({ type: d.type, name: d.name, required: d.required, fileUrl: "" }))
        });
        if (rts.length) {
          setRoomTypes(
            rts.map((rt) => ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50 flex flex-col font-sans" }, /* @__PURE__ */ React.createElement("header", { className: "h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 sticky top-0 z-30 shadow-sm" }, /* @__PURE__ */ React.createElement("button", { onClick: handleBack, className: "p-2 -ml-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(ArrowLeft, { size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-gray-900" }, step <= 9 ? `Step ${step} of 9` : "Registration Complete"), /* @__PURE__ */ React.createElement("button", { onClick: handleExit, className: "p-2 -mr-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "w-full h-1 bg-gray-200 sticky top-16 z-20" }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-emerald-600 transition-all duration-500 ease-out", style: { width: `${step / 9 * 100}%` } })), /* @__PURE__ */ React.createElement("main", { className: "flex-1 w-full max-w-2xl mx-auto p-4 md:p-6 pb-32" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-extrabold text-gray-900 mb-2" }, getStepTitle())), /* @__PURE__ */ React.createElement("div", { className: "bg-white md:p-6 md:rounded-2xl md:shadow-sm md:border md:border-gray-100 space-y-6" }, step === 1 && /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement(Home, { size: 18, className: "text-[#0F172A]" }), /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-bold" }, "Basic Info")), error && /* @__PURE__ */ React.createElement("div", { className: "text-red-600 text-sm mb-3" }, error), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 mb-1 block" }, "Hotel Name"), /* @__PURE__ */ React.createElement(
  ...
  )), /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 mb-1 block" }, "Description"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "hidden" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 mb-1 block" }, "Detailed Description"), /* @__PURE__ */ React.createElement("textarea", { className: "input w-full h-24", placeholder: "Tell guests what makes your hotel unique...", value: propertyForm.description, onChange: (e) => updatePropertyForm("description", e.target.value) })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 mb-1 block" }, "Contact Number (For Guest Inquiries)"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "tel",
      className: "input w-full",
  ...
  ))), step === 2 && /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement(MapPin, { size: 18, className: "text-[#0F172A]" }), /* @__PURE__ */ React.createElement("h2", { className: "text-lg font-bold" }, "Location")), error && /* @__PURE__ */ React.createElement("div", { className: "text-red-600 text-sm mb-3" }, error), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 mb-1 block" }, "Search Address"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      className: "input w-full",
  ...
  )), step === 3 && /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3" }, HOTEL_AMENITIES.map((am) => {
    ...
    uploading === "cover" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center gap-2 text-emerald-600" }, /* @__PURE__ */ React.createElement(Loader2, { className: "animate-spin", size: 24 }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium" }, "Uploading...")) : propertyForm.coverImage ? /* @__PURE__ */ React.createElement("div", { className: "w-full h-full relative" }, /* @__PURE__ */ React.createElement("img", { src: propertyForm.coverImage, alt: "Cover", className: "w-full h-full object-cover" }), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-white font-semibold flex items-center gap-2", onClick: (e) => {
      e.stopPropagation();
      isFlutter ? handleCameraUpload("cover", (url) => updatePropertyForm("coverImage", url)) : coverImageFileInputRef.current?.click();
    } }, /* @__PURE__ */ React.createElement(Image, { size: 18 }), " Change Image"), /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        onClick: (e) => {
    ...
    ))) : /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center gap-2 text-gray-400 group-hover:text-emerald-600 transition-colors" }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Image, { size: 24 })), /* @__PURE__ */ React.createElement("span", { className: "font-semibold text-sm" }, isFlutter ? "Take/Upload Cover Photo" : "Upload Cover Photo"))
  ), /* @__PURE__ */ React.createElement("input", { ref: coverImageFileInputRef, type: "file", accept: "image/*", className: "hidden", onChange: (e) => {
    if (e.target.files?.length) uploadImages(e.target.files, "cover", (urls) => urls[0] && updatePropertyForm("coverImage", urls[0]));
  } })), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center" }, /* @__PURE__ */ React.createElement("label", { className: "text-sm font-bold text-gray-800" }, "Gallery"), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-500" }, propertyForm.propertyImages.length, " / 4 minimum")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 sm:grid-cols-4 gap-3" }, propertyForm.propertyImages.map((img, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "aspect-square rounded-xl border border-gray-200 overflow-hidden relative group" }, /* @__PURE__ */ React.createElement("img", { src: img, alt: "", className: "w-full h-full object-cover" }), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    uploading === "gallery" ? /* @__PURE__ */ React.createElement(Loader2, { size: 24, className: "animate-spin text-emerald-600" }) : isFlutter ? /* @__PURE__ */ React.createElement(Camera, { size: 24 }) : /* @__PURE__ */ React.createElement(Plus, { size: 24 })
  )), /* @__PURE__ */ React.createElement("input", { ref: propertyImagesFileInputRef, type: "file", multiple: true, accept: "image/*", className: "hidden", onChange: (e) => {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Price / Night (\u20B9)"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement("span", { className: "absolute left-[14px] top-1/2 -translate-y-1/2 text-gray-400 font-bold" }, "\u20B9"), /* @__PURE__ */ React.createElement("input", { className: "input !pl-10 w-full", type: "number", value: editingRoomType.pricePerNight, onChange: (e) => setEditingRoomType((prev) => ({ ...prev, pricePerNight: e.target.value.replace(/^0+(?!$)/, "") })) }))), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Total Rooms"), /* @__PURE__ */ React.createElement("input", { className: "input w-full", type: "number", value: editingRoomType.totalInventory, onChange: (e) => setEditingRoomType((prev) => ({ ...prev, totalInventory: e.target.value.replace(/^0+(?!$)/, "") })) }))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Max Adults"), /* @__PURE__ */ React.createElement("input", { className: "input w-full", type: "number", value: editingRoomType.maxAdults, onChange: (e) => setEditingRoomType((prev) => ({ ...prev, maxAdults: e.target.value.replace(/^0+(?!$)/, "") })) })), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Max Children"), /* @__PURE__ */ React.createElement("input", { className: "input w-full", type: "number", value: editingRoomType.maxChildren, onChange: (e) => setEditingRoomType((prev) => ({ ...prev, maxChildren: e.target.value.replace(/^0+(?!$)/, "") })) }))), /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-50/50 p-3 rounded-xl border border-emerald-100 space-y-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-emerald-800 uppercase tracking-wider" }, "Pricing Configuration"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Base Adults Included"), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 pt-2 border-t border-gray-100" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Amenities"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, ROOM_AMENITIES.map((opt) => {
  ...
  }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 pt-4" }, /* @__PURE__ */ React.createElement("button", { type: "button", onClick: cancelEditRoomType, className: "flex-1 py-3 text-gray-600 font-semibold bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors" }, "Cancel"), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
      onClick: () => {
    ...
    "Clear"
  ), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: saveRoomType, className: "flex-1 py-3 text-white font-bold bg-emerald-600 rounded-xl hover:bg-emerald-700 shadow-md shadow-emerald-100 transition-all transform active:scale-95" }, "Save Room"))))), step === 7 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, error && /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-red-50 text-red-600 text-sm rounded-lg" }, error), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Check-in Time"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "time",
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-2 pt-2 border-t border-gray-100" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "House Rules"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, HOUSE_RULES_OPTIONS.map((r) => {
