...
const AddHostelWizard = () => {
    ...
    const loadForEdit = async () => {
      ...
      try {
        ...
        setPropertyForm({
          ...
          documents: docs.length ? docs.map((d) => ({ type: d.type || d.name, name: d.name, fileUrl: d.fileUrl || "", required: REQUIRED_DOCS_HOSTEL.find((rd) => rd.type === (d.type || d.name))?.required || false })) : REQUIRED_DOCS_HOSTEL.map((d) => ({ type: d.type, name: d.name, required: d.required, fileUrl: "" }))
        });
        if (rts.length) {
          setRoomTypes(
            rts.map((rt) => ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50 flex flex-col font-sans" }, /* @__PURE__ */ React.createElement("header", { className: "h-16 bg-white border-b border-gray-100 flex items-center justify-between px-4 sticky top-0 z-30 shadow-sm" }, /* @__PURE__ */ React.createElement("button", { onClick: handleBack, className: "p-2 -ml-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(ArrowLeft, { size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-gray-900" }, step <= 9 ? `Step ${step} of 9` : "Registration Complete"), /* @__PURE__ */ React.createElement("button", { onClick: handleExit, className: "p-2 -mr-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "w-full h-1 bg-gray-200 sticky top-16 z-20" }, /* @__PURE__ */ React.createElement("div", { className: "h-full bg-emerald-600 transition-all duration-500 ease-out", style: { width: `${step / 9 * 100}%` } })), /* @__PURE__ */ React.createElement("main", { className: "flex-1 w-full max-w-2xl mx-auto p-4 md:p-6 pb-32" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-extrabold text-gray-900 mb-2" }, getStepTitle())), /* @__PURE__ */ React.createElement("div", { className: "bg-white md:p-6 md:rounded-2xl md:shadow-sm md:border md:border-gray-100 space-y-6" }, step === 1 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, error && /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-red-50 text-red-600 text-sm rounded-lg" }, error), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Hostel Name"), /* @__PURE__ */ React.createElement(
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Property Type"), /* @__PURE__ */ React.createElement("div", { className: "px-4 py-3 bg-gray-50 border border-gray-200 text-gray-500 font-semibold rounded-xl text-sm" }, "Hostel")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Hostel Type"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    /* @__PURE__ */ React.createElement("option", { value: "boys" }, "Boys"),
    /* @__PURE__ */ React.createElement("option", { value: "girls" }, "Girls"),
    /* @__PURE__ */ React.createElement("option", { value: "mixed" }, "Mixed")
  ), /* @__PURE__ */ React.createElement("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400" }, /* @__PURE__ */ React.createElement(ChevronLeft, { size: 16, className: "-rotate-90" }))))), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Description"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "hidden" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Detailed Description"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Contact Number (For Guest Inquiries)"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "tel",
      className: "input w-full",
  ...
  )))), step === 2 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Search Location"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement("div", { className: "absolute left-[14px] top-1/2 -translate-y-1/2 text-gray-400" }, /* @__PURE__ */ React.createElement(Search, { size: 18 })), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  )), locationResults.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "absolute z-10 w-full md:w-[600px] mt-1 bg-white border border-gray-100 rounded-xl shadow-xl max-h-60 overflow-y-auto" }, locationResults.map((p, i) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: i,
      onClick: () => {
  ...
  )), step === 3 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, HOSTEL_AMENITIES.map((item) => {
    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        key: item.name,
        onClick: () => {
          const updated = isSelected ? propertyForm.amenities.filter((a) => a !== item.name) : [...propertyForm.amenities, item.name];
    ...
    uploading === "cover" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center justify-center h-full text-emerald-600 gap-2" }, /* @__PURE__ */ React.createElement(Loader2, { className: "animate-spin", size: 32 }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold" }, "Uploading...")) : propertyForm.coverImage ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("img", { src: propertyForm.coverImage, className: "w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" }), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity" }, /* @__PURE__ */ React.createElement("span", { className: "text-white font-bold flex items-center gap-2 border border-white/50 px-4 py-2 rounded-full backdrop-blur-md bg-white/10" }, /* @__PURE__ */ React.createElement(Image, { size: 18 }), " Change Cover")), /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
      e.stopPropagation();
      updatePropertyForm("coverImage", "");
    }, className: "absolute top-3 right-3 p-2 bg-white text-red-600 rounded-full shadow-lg z-10 hover:bg-red-50" }, /* @__PURE__ */ React.createElement(Trash2, { size: 16 }))) : /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-gray-400" }, /* @__PURE__ */ React.createElement("div", { className: "w-16 h-16 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center mb-3" }, /* @__PURE__ */ React.createElement(Image, { size: 32 })), /* @__PURE__ */ React.createElement("span", { className: "font-bold text-gray-600" }, isFlutter ? "Take/Upload Cover Image" : "Upload Cover Image"), /* @__PURE__ */ React.createElement("span", { className: "text-xs text-gray-400 mt-1" }, "High quality landscape photo")),
    /* @__PURE__ */ React.createElement("input", { ref: coverImageFileInputRef, type: "file", accept: "image/*", className: "hidden", onChange: (e) => uploadImages(e.target.files, "cover", (u) => updatePropertyForm("coverImage", u[0])) })
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Gallery (", propertyForm.propertyImages.length, ")"), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] bg-gray-100 px-2 py-1 rounded text-gray-500" }, "Min 4 images")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 sm:grid-cols-4 gap-3" }, propertyForm.propertyImages.map((img, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "relative aspect-square rounded-xl overflow-hidden group shadow-sm" }, /* @__PURE__ */ React.createElement("img", { src: img, className: "w-full h-full object-cover" }), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-emerald-700/20 transition-all" }), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => handleRemoveImage(img, "gallery", i), className: "absolute top-1 right-1 p-1.5 bg-white text-red-600 rounded-lg opacity-0 group-hover:opacity-100 transition-all shadow-sm transform scale-90 hover:scale-100" }, /* @__PURE__ */ React.createElement(Trash2, { size: 14 })))), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    uploading === "gallery" ? /* @__PURE__ */ React.createElement(Loader2, { className: "animate-spin text-emerald-600", size: 24 }) : /* @__PURE__ */ React.createElement(Camera, { size: 24 })
  ), /* @__PURE__ */ React.createElement("input", { ref: propertyImagesFileInputRef, type: "file", multiple: true, accept: "image/*", className: "hidden", onChange: (e) => uploadImages(e.target.files, "gallery", (u) => updatePropertyForm("propertyImages", [...propertyForm.propertyImages, ...u])) })))), step === 6 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, error && /* @__PURE__ */ React.createElement("div", { className: "p-3 bg-red-50 text-red-600 text-sm rounded-lg" }, error), !isEditingSubItem && /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("p", { className: "text-sm text-gray-500" }, "Manage your hostel inventory (Beds/Rooms).")), /* @__PURE__ */ React.createElement("div", { className: "grid gap-3" }, roomTypes.length === 0 ? /* @__PURE__ */ React.createElement("div", { className: "text-center py-10 border-2 border-dashed border-gray-200 rounded-2xl bg-gray-50/50" }, /* @__PURE__ */ React.createElement("div", { className: "w-12 h-12 bg-emerald-100 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-3" }, /* @__PURE__ */ React.createElement(Bed, { size: 24 })), /* @__PURE__ */ React.createElement("p", { className: "text-gray-500 font-medium" }, "No inventory added yet"), /* @__PURE__ */ React.createElement("p", { className: "text-xs text-gray-400 mt-1" }, "Add beds, dorms or private rooms")) : roomTypes.map((rt, index) => /* @__PURE__ */ React.createElement("div", { key: rt.id, className: "p-4 border border-gray-200 rounded-2xl bg-white group hover:border-emerald-200 transition-all shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-start" }, /* @__PURE__ */ React.createElement("div", { className: "flex gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "w-16 h-16 rounded-xl bg-gray-100 overflow-hidden flex-shrink-0 border border-gray-200" }, rt.images?.[0] ? /* @__PURE__ */ React.createElement("img", { src: rt.images[0], className: "w-full h-full object-cover" }) : /* @__PURE__ */ React.createElement("div", { className: "w-full h-full flex items-center justify-center text-gray-400" }, /* @__PURE__ */ React.createElement(Bed, { size: 20 }))), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "font-bold text-gray-900 text-lg" }, rt.name), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 text-sm text-gray-500 mt-1" }, /* @__PURE__ */ React.createElement("span", { className: "bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded text-xs font-bold uppercase tracking-wider" }, rt.roomCategory), /* @__PURE__ */ React.createElement("span", null, "\u2022"), /* @__PURE__ */ React.createElement("span", { className: "font-semibold text-gray-900" }, "\u20B9 ", rt.pricePerNight), /* @__PURE__ */ React.createElement("span", { className: "text-xs" }, "/ night")), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2 mt-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded flex items-center gap-1" }, "Beds: ", rt.bedsPerRoom), /* @__PURE__ */ React.createElement("span", { className: "text-xs bg-gray-100 text-gray-600 px-2 py-1 rounded flex items-center gap-1" }, "Inventory: ", rt.totalInventory)))), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement("button", { onClick: () => startEditRoomType(index), className: "p-2 text-emerald-600 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition-colors" }, /* @__PURE__ */ React.createElement(FileText, { size: 16 })), /* @__PURE__ */ React.createElement("button", { onClick: () => deleteRoomType(index), className: "p-2 text-red-600 bg-red-50 rounded-lg hover:bg-red-100 transition-colors" }, /* @__PURE__ */ React.createElement(Trash2, { size: 16 }))))))), /* @__PURE__ */ React.createElement(
    "button",
    {
      type: "button",
    ...
    /* @__PURE__ */ React.createElement(Plus, { size: 20 }),
    " Add Inventory"
  )), editingRoomType && /* @__PURE__ */ React.createElement("div", { className: "bg-white rounded-2xl border border-emerald-100 shadow-lg overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300" }, /* @__PURE__ */ React.createElement("div", { className: "px-4 py-3 bg-emerald-50 border-b border-emerald-100 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("span", { className: "font-bold text-emerald-800 text-sm" }, editingRoomTypeIndex === -1 ? "Add Inventory" : "Edit Inventory"), /* @__PURE__ */ React.createElement("button", { onClick: cancelEditRoomType, className: "text-emerald-600 hover:bg-emerald-100 p-1 rounded-md" }, /* @__PURE__ */ React.createElement("span", { className: "text-xs font-bold" }, "Close"))), /* @__PURE__ */ React.createElement("div", { className: "p-4 space-y-5" }, /* @__PURE__ */ React.createElement("div", { className: "p-1 bg-gray-100 rounded-xl flex" }, /* @__PURE__ */ React.createElement("button", { onClick: () => setEditingRoomType({ ...editingRoomType, roomCategory: "shared" }), className: `flex-1 py-2 text-xs font-bold rounded-lg transition-all ${editingRoomType.roomCategory === "shared" ? "bg-white text-emerald-700 shadow-sm" : "text-gray-500 hover:text-gray-700"}` }, "Shared Dorm"), /* @__PURE__ */ React.createElement("button", { onClick: () => setEditingRoomType({ ...editingRoomType, roomCategory: "private" }), className: `flex-1 py-2 text-xs font-bold rounded-lg transition-all ${editingRoomType.roomCategory === "private" ? "bg-white text-emerald-700 shadow-sm" : "text-gray-500 hover:text-gray-700"}` }, "Private Room")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Name"), /* @__PURE__ */ React.createElement("input", { className: "input", placeholder: "e.g. 4 Sharing Air Conditioned Dorm", value: editingRoomType.name, onChange: (e) => setEditingRoomType({ ...editingRoomType, name: e.target.value }) })), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Price per Night (\u20B9)"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement("span", { className: "absolute left-[14px] top-1/2 -translate-y-1/2 text-gray-400 font-bold" }, "\u20B9"), /* @__PURE__ */ React.createElement("input", { className: "input !pl-10", type: "number", placeholder: "0", value: editingRoomType.pricePerNight, onChange: (e) => setEditingRoomType({ ...editingRoomType, pricePerNight: e.target.value.replace(/^0+(?!$)/, "") }) }))), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Units/Inventory"), /* @__PURE__ */ React.createElement("input", { className: "input", type: "number", placeholder: "1", value: editingRoomType.totalInventory, onChange: (e) => setEditingRoomType({ ...editingRoomType, totalInventory: e.target.value.replace(/^0+(?!$)/, "") }) })), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Beds per Room"), /* @__PURE__ */ React.createElement("input", { className: "input", type: "number", placeholder: "1", value: editingRoomType.bedsPerRoom, onChange: (e) => setEditingRoomType({ ...editingRoomType, bedsPerRoom: e.target.value.replace(/^0+(?!$)/, "") }) })), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Max Adults"), /* @__PURE__ */ React.createElement("input", { className: "input", type: "number", placeholder: "1", value: editingRoomType.maxAdults, onChange: (e) => setEditingRoomType({ ...editingRoomType, maxAdults: e.target.value.replace(/^0+(?!$)/, "") }) }))), /* @__PURE__ */ React.createElement("div", { className: "bg-emerald-50/50 p-3 rounded-xl border border-emerald-100 space-y-3" }, /* @__PURE__ */ React.createElement("span", { className: "text-[10px] font-bold text-emerald-800 uppercase tracking-wider" }, "Pricing Configuration"), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Base Adults Included"), /* @__PURE__ */ React.createElement(
    "input",
    {
  ...
  } }))), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "Room/Bed Amenities"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, ROOM_AMENITIES.map((opt) => {
    ...
    /* @__PURE__ */ React.createElement("option", { value: "Strict" }, "Strict")
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500" }, "House Rules"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
      className: "input w-full min-h-[100px]",
    ...
    loading ? /* @__PURE__ */ React.createElement(Loader2, { size: 18, className: "animate-spin" }) : null,
