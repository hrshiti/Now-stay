...
const AddPGWizard = () => {
    ...
    const loadForEdit = async () => {
      ...
      try {
        ...
        setPropertyForm({
          ...
          documents: docs.length ? docs.map((d) => ({ type: d.type || d.name, name: d.name, fileUrl: d.fileUrl || "", required: REQUIRED_DOCS_PG.find((rd) => rd.type === (d.type || d.name))?.required || false })) : REQUIRED_DOCS_PG.map((d) => ({ type: d.type, name: d.name, required: d.required, fileUrl: "" }))
        });
        if (rts.length) {
          setRoomTypes(
            rts.map((rt) => ({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "min-h-screen bg-gray-50 flex flex-col font-sans" }, /* @__PURE__ */ React.createElement("div", { className: "sticky top-0 z-30 bg-white border-b border-gray-100 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-2xl mx-auto px-4 h-16 flex items-center justify-between" }, /* @__PURE__ */ React.createElement("button", { onClick: handleBack, className: "p-2 -ml-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(ArrowLeft, { size: 20 })), /* @__PURE__ */ React.createElement("div", { className: "text-sm font-bold text-gray-900" }, step <= 9 ? `Step ${step} of 9` : "Registration Complete"), /* @__PURE__ */ React.createElement("button", { onClick: handleExit, className: "p-2 -mr-2 text-gray-600 hover:bg-gray-100 rounded-full transition-colors" }, /* @__PURE__ */ React.createElement(X, { size: 20 }))), /* @__PURE__ */ React.createElement("div", { className: "h-1 bg-gray-100 w-full" }, /* @__PURE__ */ React.createElement(
  ...
  ))), /* @__PURE__ */ React.createElement("main", { className: "flex-1 max-w-2xl mx-auto w-full p-4 md:p-6 pb-32" }, /* @__PURE__ */ React.createElement("div", { className: "max-w-xl mx-auto" }, /* @__PURE__ */ React.createElement("div", { className: "mb-6" }, /* @__PURE__ */ React.createElement("h1", { className: "text-2xl font-extrabold text-gray-900 mb-2" }, getStepTitle())), step === 1 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Property Name"), /* @__PURE__ */ React.createElement(
    "input",
    {
      className: "input",
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Category"), /* @__PURE__ */ React.createElement("div", { className: "w-full px-4 py-3 bg-gray-100 border border-gray-200 rounded-xl text-gray-500 font-medium text-sm" }, "PG / Co-living")), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "PG Type"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    /* @__PURE__ */ React.createElement("option", { value: "unisex" }, "Unisex")
  ), /* @__PURE__ */ React.createElement("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400" }, /* @__PURE__ */ React.createElement(ChevronLeft, { size: 16, className: "-rotate-90" }))))), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Meals Included"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "select",
    {
    ...
    /* @__PURE__ */ React.createElement("option", { value: "No" }, "Not Included"),
    /* @__PURE__ */ React.createElement("option", { value: "Yes" }, "Food Included")
  ), /* @__PURE__ */ React.createElement("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400" }, /* @__PURE__ */ React.createElement(ChevronLeft, { size: 16, className: "-rotate-90" })))), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Food Type"), /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
    "select",
    {
      className: "input appearance-none bg-white pr-10",
    ...
    /* @__PURE__ */ React.createElement("option", { value: "none" }, "N/A"),
    /* @__PURE__ */ React.createElement("option", { value: "Veg" }, "Veg Only"),
    /* @__PURE__ */ React.createElement("option", { value: "Non-Veg" }, "Non-Veg"),
    /* @__PURE__ */ React.createElement("option", { value: "Both" }, "Veg & Non-Veg")
  ), /* @__PURE__ */ React.createElement("div", { className: "absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400" }, /* @__PURE__ */ React.createElement(ChevronLeft, { size: 16, className: "-rotate-90" }))))), /* @__PURE__ */ React.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Notice Period"), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "text",
      className: "input",
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "hidden" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Detailed Description"), /* @__PURE__ */ React.createElement(
    "textarea",
    {
  ...
  )), step === 3 && /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-3" }, PG_AMENITIES.map((item) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: `w-10 h-10 rounded-full flex items-center justify-center transition-colors ${isSelected ? "bg-emerald-100" : "bg-gray-100"}` }, item.name === "WiFi" ? /* @__PURE__ */ React.createElement(Wifi, { size: 20, className: isSelected ? "text-emerald-600" : "text-gray-400" }) : /* @__PURE__ */ React.createElement(CheckCircle, { size: 20, className: isSelected ? "text-emerald-600" : "text-gray-400" })),
      /* @__PURE__ */ React.createElement("span", { className: "font-bold text-sm" }, item.name)
    );
    ...
    uploading === "cover" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center justify-center h-full text-emerald-600 gap-2" }, /* @__PURE__ */ React.createElement(Loader2, { className: "animate-spin", size: 32 }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold" }, "Uploading...")) : propertyForm.coverImage ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("img", { src: propertyForm.coverImage, className: "w-full h-full object-cover" }), /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center" }, /* @__PURE__ */ React.createElement("button", { onClick: (e) => {
      e.stopPropagation();
      isFlutter ? handleCameraUpload("cover", (u) => updatePropertyForm("coverImage", u)) : coverImageFileInputRef.current?.click();
    }, className: "px-4 py-2 bg-white/20 backdrop-blur-md border border-white/50 text-white rounded-xl font-bold text-sm hover:bg-white/30" }, "Change Cover"))) : /* @__PURE__ */ React.createElement("div", { className: "flex flex-col items-center justify-center h-full text-gray-400" }, /* @__PURE__ */ React.createElement(Image, { size: 32, className: "mb-2" }), /* @__PURE__ */ React.createElement("span", { className: "text-sm font-bold" }, isFlutter ? "Take/Upload Cover Image" : "Upload Cover Image")),
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "space-y-3" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-between items-center px-1" }, /* @__PURE__ */ React.createElement("label", { className: "text-xs font-semibold text-gray-500 uppercase tracking-wider" }, "Property Gallery (Min 4)"), /* @__PURE__ */ React.createElement("span", { className: "text-[10px] text-gray-400" }, propertyForm.propertyImages.length, " images")), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-3 sm:grid-cols-4 gap-3" }, propertyForm.propertyImages.map((img, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: "relative aspect-square rounded-xl overflow-hidden group bg-gray-100" }, /* @__PURE__ */ React.createElement("img", { src: img, className: "w-full h-full object-cover" }), /* @__PURE__ */ React.createElement("button", { type: "button", onClick: () => handleRemoveImage(img, "gallery", i), className: "absolute top-1 right-1 w-6 h-6 bg-red-500 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all shadow-sm transform scale-90 group-hover:scale-100" }, /* @__PURE__ */ React.createElement(X, { size: 12 })))), /* @__PURE__ */ React.createElement(
    "button",
    {
