...
export const addRoomType = async (req, res) => {
  try {
    ...
    const { name, inventoryType, roomCategory, maxAdults, maxChildren, baseAdults, baseChildren, bedsPerRoom, totalInventory, pricePerNight, extraAdultPrice, extraChildPrice, images, amenities } = req.body;
    ...
    const rt = await RoomType.create({
      ...
      baseAdults, baseChildren, bedsPerRoom, totalInventory, pricePerNight, 
      extraAdultPrice, extraChildPrice, images: normalizedImages, amenities
    });
...
export const updateRoomType = async (req, res) => {
  try {
    ...
    const updatableFields = ['name', 'inventoryType', 'roomCategory', 'maxAdults', 'maxChildren', 'baseAdults', 'baseChildren', 'bedsPerRoom', 'totalInventory', 'pricePerNight', 'extraAdultPrice', 'extraChildPrice', 'images', 'amenities', 'isActive'];
    updatableFields.forEach(field => {
      if (Object.prototype.hasOwnProperty.call(payload, field)) {
